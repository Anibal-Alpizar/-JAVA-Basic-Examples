...
public class Coche {
	...
	private int ruedas; 								//private encapsula y no puede modificar los valores desde otra clase
	private int largo; 
	private int ancho; 
	private int peso_plataforma; 
	private String color;
	private int peso_total;
	private boolean asientos_cuero, climatizador; 				//true false
	...
	public String dime_peso_coche() {		//set + get
